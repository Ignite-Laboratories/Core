...
func Differential[TValue any](engine *core.Engine, potential core.Potential, muted bool, looping bool, calculate core.CalculatePoint[TValue]) *Dimension[TValue, any] {
