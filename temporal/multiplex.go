...
func NewMultiplex[TValue core.Numeric](engine *core.Engine, potential core.Potential, muted bool, blend core.Blend[TValue], dimensions ...*Dimension[any, any]) *Dimension[TValue, any] {
